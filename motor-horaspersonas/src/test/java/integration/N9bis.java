...
public class N9bis extends JUnitBase{
	private final static String changeSetFile = "change-set/change-set-horaspersonas-BRA.xml";
    ...
    public void comprobarAccion() {
		...
		assertEquals(132, factResponse.getHorasNormales(), delta);
		assertEquals(891, factResponse.getHorasExtrasEfetivas(), delta); 
		//N9
		assertEquals(0, factResponse.getHorasExtras50Xpersona(), delta);
		assertEquals(297, factResponse.getHorasExtrasXpersona(), delta);
    ...
    public void comprobarAccion2() {
		...
		assertEquals(0, factResponse.getHorasAdicIntrajornada(), delta);
		assertEquals(30, factResponse.getNumeroHorasFestivosMesProporcionalLibres(), delta); 
		...
		//N8
		assertEquals(0, factResponse.getHorasExtras50Xpersona(), delta);
		assertEquals(551.57142, factResponse.getHorasNormales(), delta);
		assertEquals(200.57142, factResponse.getHorasExtrasEfetivas(), delta); 
