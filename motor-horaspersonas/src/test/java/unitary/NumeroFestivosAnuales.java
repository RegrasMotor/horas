...
public class NumeroFestivosAnuales extends JUnitBase {

private final static String rulesFile = "rules/horaspersonas/BRA/Numero de festivos anuales.drl";
    ...
    public void comprobarAccion1() {
		...
		assertEquals(17, factResponse.getNumeroFestivosAnuales(), delta);
    }
    ...
    public void comprobarAccion2() {
		...
		assertEquals(14, factResponse.getNumeroFestivosAnuales(), delta);
    }
